        ...
        <main class="grow grid place-items-center">
            <div class="w-full mx-auto px-4 sm:px-6">
                <div class="py-[100px]">
                    ...
                    <form action="/admin/costs/{{ $cost->id }}" method="post" class="mt-10">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="flex flex-col items-center">
                            ...
                            <div class="mt-8 w-full flex items-center justify-center gap-10">
                                ...
                                <button type="submit" class="mt-8 p-4 bg-sky-800 text-white w-full max-w-xs hover:bg-slate-900 transition-colors">
                                    更新
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="mt-8 w-full flex items-center justify-center gap-10">
                        <a href="/admin/costs" class="block shrink-0 bg-sky-500 text-white px-6 py-2 rounded-md hover:bg-sky-800 transition-colors duration-300">
                            戻る
                        </a>
                    </div>
        ...
        <footer class="bg-sky-800">
            <div class="max-w-7xl mx-auto px-4 sm:px-6">
                <div class="py-4 text-center">
                    <p class="text-white text-sm">管理者用経費編集</p>
                </div>
            </div>
        </footer>
</body>
