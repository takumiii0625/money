...
class TaskController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('tasks.index', compact('tasks')); // ['tasks' => $tasks]と同義
    }
    ...
    public function store(Request $request)
    {
        ...
        Validator::make($request->all(), $rules, $messages)->validate(); //validateメソッドを呼び出すことで、エラーがあったときは元の画面に戻るようにしています。
